...
public enum Dogbreed {
    ...
    FRENCH_BULLDOG         ("French Bulldog",         Size.SMALL,    Ears.BAT,          Tail.SCREW,         Coat.SHORT_SMOOTH,  Feet.CAT),
    GOLDEN_RETRIEVER       ("Golden Retriever",       Size.LARGE,    Ears.FOLDED,       Tail.OTTER_SABER,   Coat.SHORT_LONG,    Feet.WEBBED),
    GERMAN_SHEPHERD        ("German Shepherd",        Size.LARGE,    Ears.ERECT,        Tail.OTTER_SABER,   Coat.SHORT_LONG,    Feet.CAT),
